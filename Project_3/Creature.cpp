...
/**
        ...
        */
        bool Creature::operator==(const Creature& rhs) const{   //return true or fals based on the bool function 
        ...
        */
        bool Creature::operator!=(const Creature& rhs) const{
          return !(*this == rhs);        //opposite of the operator function == this by default is not a reference 
        }