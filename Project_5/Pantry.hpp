...
this part is hidden from the interface where we create functions 
*/
...
/**
  ...
  */
    ...
    Ingredient(const std::string& name, const std::string& description, const int& quantity, const int& price, const std::vector<Ingredient*>& recipe) : 
...
class Pantry : public LinkedList <Ingredient*>{
    ...
    */
    bool addIngredient(Ingredient* add);
    ...
    */
    bool addIngredient(const std::string& name, const std::string& ingredient_description, const int& ingredient_quantity, const int& ingredient_price, const std::vector<Ingredient*>& recipe);
    ...
    */
    bool canCreate(Ingredient* can_create_ingredient) const;
    ...
    */
    void printIngredient(Ingredient* print_ingredient) const;
    ...
    */
    void ingredientQuery(const std::string& ingredient_query) const;

    void ingredientQuery_Helper(Ingredient* ingredient_helper) const;
