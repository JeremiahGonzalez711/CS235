...
class Cavern : public ArrayBag<Creature*>{
  public:
    ...
    **/
    bool enterCavern(Creature* new_creature); //(const Creature& new_creature)
    ...
    **/
    bool exitCavern(Creature* creature_to_remove); //(const Creature& creature_to_remove)

    /** 
    * @return   :  The integer level count of all the creatures currently in the Cavern
    **/
    int getLevelSum() const ; //const;
    ...
    **/
    int calculateAvgLevel() const; //const;

    /**
    * @return   :  The integer count of tame Creatures in the Cavern
    **/
    int getTameCount()const ; //const;
    ...
    **/
    double calculateTamePercentage() const; //const;
    ...
    **/
    int tallyCategory(const std::string& category) const; //const;
    ...
    */
    void displayCategory(const std::string& category) const; //const;
