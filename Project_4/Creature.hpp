...
making the display function pure virtual and eatMycoMorsel virtual aswell
*/
...
class Creature
{
        ...
        */
        bool isTame() const;
         ...
         /**
            ...
            Tame: [TRUE/FALSE]"   
        */
        virtual void display() const = 0;   //setting to pure virtual 
    ...
    */
    ...
    virtual bool eatMycoMorsel() = 0; //pure virtual 
